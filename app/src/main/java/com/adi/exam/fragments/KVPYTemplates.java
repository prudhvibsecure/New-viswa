...
public class KVPYTemplates extends ParentFragment implements View.OnClickListener, IItemHandler, IFileUploadCallback {
    ...
    public static KVPYTemplates newInstance(String data) {

        KVPYTemplates fragment = new KVPYTemplates();
