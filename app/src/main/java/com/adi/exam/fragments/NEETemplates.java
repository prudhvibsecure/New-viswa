...
public class NEETemplates extends ParentFragment implements View.OnClickListener , IItemHandler, IFileUploadCallback {
    ...
    public static NEETemplates newInstance(String data) {
        ...
        try {
            ...
            if (currentExamId != -1) {
                ...
                if (jsonArray.length() > 0) {
                    ...
                    }else if (jsonObject.optInt("qstate") == 4) {
                        jsonObject1.put("marked_for_review", "1");
                    } else {
