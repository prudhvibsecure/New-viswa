...
public class AIIMSemplates extends ParentFragment implements View.OnClickListener, IItemHandler, IFileUploadCallback {
    ...
    public static AIIMSemplates newInstance(String data) {

        AIIMSemplates fragment = new AIIMSemplates();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        layout = inflater.inflate(R.layout.fragment_aimstemplates, container, false);
